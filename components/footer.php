    ...
    <div class="contact-info footer-section">
      ...
      <div class="social-container">
        <div class="social social-facebook">
          <img class="icon-fb soc-icon" src="icons/icons8-facebook-100.png" alt="black and white icon of facebook">
        </div>
        <div class="social social-instagram">
          <img class="icon-ig soc-icon" src="icons/icons8-instagram-100.png" alt="black and white icon of facebook">
        </div>
